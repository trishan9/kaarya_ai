...
class RecruiterOverviewScreen extends ConsumerStatefulWidget {
  const RecruiterOverviewScreen({super.key});

  @override
  ConsumerState<RecruiterOverviewScreen> createState() =>
...
class _SummaryCards extends StatelessWidget {
  ...
  final RecruiterOverviewData overview;
